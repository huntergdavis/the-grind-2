...
const sourcePaths = Object.freeze([
  ...
  "src/core/types.ts",
  "src/depth/atlas.ts",
  "src/depth/better-question.ts",
  "src/depth/borrowed-bell-campaign.ts",
  "src/depth/borrowed-bell-memory.ts",
  "src/depth/borrowed-bell.ts",
  "src/depth/combat-damage.ts",
  "src/depth/combat.ts",
  "src/depth/companion-credit.ts",
  "src/depth/companion-kit.ts",
  "src/depth/companion-reunion.ts",
  "src/depth/companion.ts",
  "src/depth/dungeon-field-medicine.ts",
  "src/depth/dungeon-lair.ts",
  "src/depth/elsewhere-loaf.ts",
  ...
  "src/depth/road-rations.ts",
  "src/depth/road-supper.ts",
  "src/depth/roadside-rest.ts",
  "src/depth/room-challenge.ts",
  "src/depth/rpg.ts",
  "src/depth/shared-opening.ts",
  "src/depth/smithy-job.ts",
  "src/depth/spare-gear-trade.ts",
  "src/depth/supper-preparation.ts",
