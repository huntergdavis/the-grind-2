...
describe("captured moment-selection provenance", () => {
  ...
  it.each([
    ...
    { choice: "current", origin: "focus" },
    { choice: "current", origin: "focus", kind: "first-shared-victory" },
    { choice: "current", origin: "MODEL" },
    ...
    { choice: "milestone", origin: "focus" },
    { choice: "milestone", origin: "focus", kind: "other-milestone" },
    { choice: "milestone", origin: "focus", kind: "farewell-remembrance", extra: "private" },
    { choice: "milestone", origin: "FOCUS", kind: "farewell-remembrance" },
    { choice: "milestone", origin: "focus", kind: "first-shared-victory " },
    { choice: "milestone", origin: "focus", kind: "first-shared-victory", extra: "private" },
