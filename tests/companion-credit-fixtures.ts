...
function companionCreditJourney(): { beforeVictory: WorldState; ready: WorldState } {
  ...
  let world = companionCreditTownStartFixture(), previous: WorldState | undefined;
  ...
  throw new Error("Known second-town boundary did not earn companion credit within 96 actual commands");
}
